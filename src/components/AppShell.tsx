...
import { Home, UserCircle, ImageIcon, MessageSquare, Send, Settings, Briefcase, Images, Menu, LogOut, LogIn as LogInIcon, Sparkles } from 'lucide-react'; // Added Sparkles
    ...
    <div className="flex flex-col h-full">
      <div className="p-4 border-b border-sidebar-border">
        <Link href={user ? "/dashboard" : "/"} className="flex items-center gap-2 text-sidebar-foreground hover:text-sidebar-primary-foreground">
          {/* NextImage component that displayed brandForgeAppLogoDataUri removed, replaced with Sparkles icon */}
          <Sparkles className="w-8 h-8 text-sidebar-primary" /> {/* Adjusted Sparkles size for sidebar */}
